...
Visit https://github.com/aziontech/azion/releases to download the correct packagePlease run: 'sudo dpkg -i <downloaded_file>' to update it to v1.17.0
...
__azion_handle_go_custom_completion()
{
    ...
    # Calling ${words[0]} instead of directly azion allows to handle aliases
    args=("${words[@]:1}")
...
_azion_delete_cache-setting()
{
    ...
    local_nonpersistent_flags+=("--application-id")
    local_nonpersistent_flags+=("--application-id=")
    flags+=("--cache-settings-id=")
    two_word_flags+=("--cache-settings-id")
    local_nonpersistent_flags+=("--cache-settings-id")
    local_nonpersistent_flags+=("--cache-settings-id=")
    flags+=("--help")
    flags+=("-h")
    local_nonpersistent_flags+=("--help")
